...
const FAQs = () => {
    return (
        <div className='flex  gap-16 justify-between max-sm:flex-wrap'>
            <div className='w-[52rem] h-[30rem] mt-12 relative bg-blue-2 rounded-t-[50%]'>
                <Image
            ...
            <div className="w-full space-y-4 mt-10">
                ...
                <details className="group border-s-8 border-green-4 bg-blue-2 px-6 py-3">
                    <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                        <h2 className="text-lg font-medium text-white">
                            What is sports betting prediction?
                        </h2>

                        <span className="shrink-0 rounded-full bg-green-4 p-1.5 text-white sm:p-3">
                            <svg
