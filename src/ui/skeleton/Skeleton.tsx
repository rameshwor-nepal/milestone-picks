...
const Skeleton = () => {
    // Single skeleton card component for reuse
    const SkeletonCard = () => (
        <div
            role="status"
            className="p-4 w-full border border-gray-400 rounded-sm shadow-sm animate-pulse md:p-6 "
        >
            <div className="flex items-center justify-center h-48 mb-4 bg-gray-500 rounded-sm ">
                <svg
