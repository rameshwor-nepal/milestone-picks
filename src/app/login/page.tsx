        ...
        <div className="flex items-center justify-center min-h-screen w-full">
            <div className="flex bg-blue-1 rounded-lg shadow-sm shadow-black-3 overflow-hidden mx-auto max-w-sm w-full lg:max-w-4xl">
                ...
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    {/* <a href="#" className="flex items-center justify-center mt-4 text-white rounded-lg bg-green-3/20 shadow-md transition-all hover:bg-green-3/30">
                        ...
                        <h1 className="px-4 py-3 w-5/6 text-center text-gray-50 font-bold">Sign in with Google</h1>
                    </a>
                    ...
                    <div className="mt-8">
                        <button className="bg-green-2 text-white font-bold py-2 px-4 w-full rounded transition-all hover:bg-green-2/80">Login</button>
                    </div>
                    <div className="mt-4 flex items-center justify-between">
